...
local function set_groups()
  local groups = {
    ...
    -- changed this
    NonText                     = { fg = colors.gutter_active },
    ...
    -- Obsidian
    ObsidianBlockID             = { fg = colors.constant },
    ObsidianTag                 = { fg = colors.constant },
    ObsidianBullet              = { fg = colors.constant },
    ObsidianDone                = { fg = colors.constant },
    ObsidianHighlightText       = { bg = colors.vcs_added_bg },
    --
    -- HTML
